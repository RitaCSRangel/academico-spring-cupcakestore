...
// definido no application.properties. Os métodos do Jpa serão usados no UserOrdersService.
public interface UserOrderRepository extends JpaRepository<UserOrder, Long> {
    ...
    Optional<UserOrder> findUserOrderById(Long id);
    Optional<List<UserOrder>> findUserOrderByUserId(Long userid);
